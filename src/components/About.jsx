        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
                ...
                <div className="w-full md:w-1/2 text-center md:text-left">
                    ...
                    Welcome to Our Store, your one-stop destination for fashion, electronics, home essentials, etc. At E-Shop, we are dedicated to bringing you 
                    the best products at unbeatable prices, ensuring a seamless shopping experience tailored to your needs.
                    </p>
                </div>

                <div className="w-full md:w-1/2 mb-6 md:mb-0">
                    <img alt="About Us" 
                    className="w-full h-auto rounded-lg shadow-lg transform transition duration-300 md:hover:scale-105" src="https://embarkx.com/sample/placeholder.png"></img>
                </div>
            </div>
