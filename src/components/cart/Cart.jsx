...
const Cart = () => {
    ...
    const newCart = {...cart}; // Creating A Copy Of The Cart Since Redux Does Not Allow Manipulation Of The Original Object
    ...
    if(!cart || cart.length===0) {
        ...
        //         <h1 className="font-bold mt-4 text-4xl">Cart Is Empty</h1>
        // </div>
        <CartEmpty />
    )
    } 
